...
export default function draftshop() {
    ...
    const [searchQ, setSearchQ] = useState('');
      ...
      const {alldata, loading} = useFetchData('/api/shops',refresh);
  ...
  const router = useRouter();
      ...
      function goBack() {
       // console.log("BlogAllData", BlogAllData)
         setRefresh(!refresh);
         setDelete(false);
        router.push('/shops/process');
         
     }
     async function deletBlog(id) {
        // console.log("delete id", id)
         await axios.post("/api/shops", {productId: id}).then(res => {
...
<> 
                  <div className="blogpage">
                           ...
                           <div>
                                <h2>All Drafted <span>Products</span></h2>
                                <h3>ADMIN PANEL</h3>
                           </div>
